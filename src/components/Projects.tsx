...
const Projects: React.FC = () => {
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-pink-50 via-pink-100 to-pink-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Express to Empower: A revolutionary approach to teaching children about 
            bodies, boundaries, and identity through creative storytelling.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden mb-16">
          <div className="grid lg:grid-cols-2 gap-0">
            <div className="p-12 lg:p-16">
              <div className="inline-block bg-gradient-to-r from-pink-500 to-pink-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-6">
                Flagship Project
              </div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Bodies, Boundaries, and Identity - A 20-page cartoon-based activity book 
                designed to teach children about personal safety and body autonomy in an 
                engaging, age-appropriate way.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Real anatomical terms - no euphemisms</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-pink-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                  </div>
                  <p className="text-gray-700">Colorful illustrations and interactive activities</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-pink-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">RM25 per copy - supporting free distribution</p>
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-sm text-gray-500 mt-2">Recent workshop at Sri KDU International School</p>
          </div>
          <div className="text-center bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
