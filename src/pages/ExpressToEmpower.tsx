          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="#workshops" className="inline-flex items-center bg-gradient-to-r from-pink-600 to-pink-500 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg">
                  Bring to My School <ArrowRight className="w-5 h-5 ml-2" />
                </a>
                <a href="#pocket-pal" className="inline-flex items-center border-2 border-pink-600 text-pink-600 px-6 py-3 rounded-full font-semibold hover:bg-pink-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            ...
            <Card className="p-8 flex flex-col" id="pocket-pal">
              ...
              <a href="#order-pocket-pal" className="mt-auto inline-flex items-center border-2 border-pink-600 text-pink-600 px-6 py-3 rounded-full font-semibold hover:bg-pink-50">Order Your Pocket Pal <ArrowRight className="w-4 h-4 ml-2" /></a>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <a href="#order-pocket-pal" className="mt-4 inline-flex items-center border-2 border-pink-600 text-pink-600 px-6 py-3 rounded-full font-semibold hover:bg-pink-50">Order Your Pocket Pal <ArrowRight className="w-4 h-4 ml-2" /></a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#donate" className="bg-white text-pink-600 px-8 py-4 rounded-full font-semibold hover:shadow-xl">Donate Now</a>
